...
">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text-area" name="description" class="form-control" id="inputDescription" placeholder= "Write the description of the Outlaw">
                            </div>
                            <div class="col-md-2">
                            ...
                            <div class="btnCreate">
                                <button type="submit" class="btn btn-outline-success" value="Create">Create Manhunt Quest</button>
                            </div>
                            </form>
                        </div>
                        </div>
